...
urlpatterns = [
    ...
    url(r'^user_change/$', views.user_change, name='user_change'),  # 修改个人信息
    url(r'^order_info/$', views.order_info, name='order_info'),  # 已购航班
    url(r'^score/$', views.score, name='score'),  # 个人积分
